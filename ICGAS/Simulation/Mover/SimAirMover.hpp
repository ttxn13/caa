...
class SimAirMover : public SimMover
{
public:
...
private:
	...
	S_PLAT_STATE step_del_radial(const S_PLAT_STATE* plat_state, const double del_angle_rad, const double max_radial_load_g) const;
};
